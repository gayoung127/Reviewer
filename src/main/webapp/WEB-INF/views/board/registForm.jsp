...
<body>
	...
	<form action="regist" method="post" >
		<input type="text" name="title" max="40" required> <input
			type="text" name="writer" value="<%= (String) session.getAttribute("loginUserName") %>"
			readonly> <input type="text" name="restaurant" max="45"
			required>
		<textarea name="coment" minlength="10" maxlength="255"
			placeholder="한줄평을 남겨주세요." required></textarea>
		<!-- 리뷰 입력 필드들 -->
		<div id="reviewContainer">
			<div class="review-form-group">
				<label>Menu 1</label> <input type="text" name="reviews[0].foodName"
					placeholder="음식 이름" maxlength="25" required> <input
					type="text" name="reviews[0].foodComent" placeholder="음식은 어땠나요?"
					maxlength="40" required> <input type="range"
					name="reviews[0].foodRating" min="0" max="5" required>
